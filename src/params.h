...
const double PARAM_CENTER_X = 1000.0;
const double PARAM_CENTER_Y = 2000.0;
...
const double PARAM_MAX_SPEED_MPH = 49.0;

const double PARAM_MAX_SPEED = 22.0; // m.s-1
...
const double PARAM_DIST_SLOW_DOWN = 30.0; // when a car is 30 m ahead of us => adjust speed if needed
